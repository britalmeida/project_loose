...
function Init_sounds()
  ...
  FROG_SOUND.tickleface:setVolume(0.9)
  FROG_SOUND.fire:setVolume(0.9)
  SOUND.fire_blow:setVolume(0.8)
  SOUND.bubble_pop_01:setVolume(0.9)
  SOUND.bubble_pop_02:setVolume(0.9)
  SOUND.bubble_pop_03:setVolume(0.9)
  SOUND.folding_open:setVolume(0.9)
  SOUND.folding_close:setVolume(0.9)
  SOUND.into_cocktail_menu:setVolume(0.9)
  SOUND.into_main_menu:setVolume(0.9)
end