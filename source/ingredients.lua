...
INGREDIENT_TYPES = {
    ...
    { name="Spiderweb",     drop_name="spider",       rune_composition={ -0.33,  1,     0   }, x=365,  y=105, img=gfxi.new('images/ingredients/spiderweb'),    drop=gfxi.new('images/ingredients/spiderweb_drop'),   hold=gfxi.new('images/ingredients/spiderweb_held')  },
    { name="Snail Shells",  drop_name="snail shell",  rune_composition={  0.33,  0,    -1   }, x= 20,  y=140, img=gfxi.new('images/ingredients/snailshells'),  drop=gfxi.new('images/ingredients/snailshells_drop'), hold=gfxi.new('images/ingredients/snailshells_held')  },
}
