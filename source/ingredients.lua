...
INGREDIENT_TYPES = {
    { name="Peppermints",   drop_name="peppermint",   rune_composition={  4,  -2,   2  }, x=375,  y= 27, img=gfxi.new('images/ingredients/peppermints'),  drop=gfxi.new('images/ingredients/peppermints_drop'), hold=nil },
    { name="Perfume",       drop_name="perfume drop", rune_composition={  6,   0,  -2  }, x=330,  y= 32, img=gfxi.new('images/ingredients/perfume'),      drop=gfxi.new('images/ingredients/perfume_drop'),     hold=nil  },
    { name="Mushrooms",     drop_name="mushroom",     rune_composition={  0,   4,   4  }, x=270,  y= 28, img=gfxi.new('images/ingredients/mushrooms'),    drop=gfxi.new('images/ingredients/mushrooms_drop'),   hold=nil  },
    { name="Coffee Beans",  drop_name="coffee bean",  rune_composition={  2,  -4,   4  }, x= 33,  y= 81, img=gfxi.new('images/ingredients/coffee'),       drop=gfxi.new('images/ingredients/coffee_drop'),      hold=nil  },
    ...
    { name="Salt",          drop_name="salt",         rune_composition={  0,  -6,  -2  }, x= 64,  y= 28, img=gfxi.new('images/ingredients/salt'),         drop=gfxi.new('images/ingredients/salt_drop'),        hold=nil  },
    { name="Garlic",        drop_name="garlic clove", rune_composition={ -2,  -4,   6  }, x=280,  y= 95, img=gfxi.new('images/ingredients/garlic'),       drop=gfxi.new('images/ingredients/garlic_drop'),      hold=gfxi.new('images/ingredients/garlic_held')  },
    { name="Spiderweb",     drop_name="spider",       rune_composition={ -4,   6,   0  }, x=365,  y=105, img=gfxi.new('images/ingredients/spiderweb'),    drop=gfxi.new('images/ingredients/spiderweb_drop'),   hold=gfxi.new('images/ingredients/spiderweb_held')  },
